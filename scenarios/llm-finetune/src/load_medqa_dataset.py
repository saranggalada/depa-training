...
handler = DatasetHandler(dataset_name=DATASET_NAME, dataset_split=DATASET_SPLIT)

# Load from HuggingFace
dataset = handler.load_from_huggingface()

# Save locally in Parquet format (recommended)
save_path = handler.save_locally(save_dir=SAVE_DIR, format="csv")

# Load from local storage
# dataset = handler.load_locally(local_dir=SAVE_DIR, format="csv")