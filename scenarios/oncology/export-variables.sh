...
declare -x AZURE_GENOMICS_LAB_CONTAINER_NAME=genomicslabcontainer
export AZURE_GENOMICS_LAB_CONTAINER_NAME
declare -x AZURE_PHARMACEUTICAL_COMPANY_CONTAINER_NAME=pharmaceuticalcompanycontainer
export AZURE_PHARMACEUTICAL_COMPANY_CONTAINER_NAME
declare -x AZURE_COMPUTATIONAL_BIOLOGY_LAB_CONTAINER_NAME=computationalbiologylabcontainer
export AZURE_COMPUTATIONAL_BIOLOGY_LAB_CONTAINER_NAME
declare -x AZURE_CANCER_INSTITUTE_CONTAINER_NAME=cancerinstitutecontainer
export AZURE_CANCER_INSTITUTE_CONTAINER_NAME
declare -x AZURE_OUTPUT_CONTAINER_NAME=outputcontainer
export AZURE_OUTPUT_CONTAINER_NAME

# For cloud resource creation:
declare -x SCENARIO="oncology"
