...
def main():
    ...
    genomics_lab_path = os.getenv('GENOMICS_LAB_INPUT_PATH', '/mnt/remote/genomics_lab')
    pharma_path = os.getenv('PHARMACEUTICAL_COMPANY_INPUT_PATH', '/mnt/remote/pharmaceutical_company')
    comp_bio_path = os.getenv('COMPUTATIONAL_BIOLOGY_LAB_INPUT_PATH', '/mnt/remote/computational_biology_lab')
    cancer_inst_path = os.getenv('CANCER_INSTITUTE_INPUT_PATH', '/mnt/remote/cancer_institute')
    output_path = os.getenv('FEATURE_ENGINEERING_OUTPUT_PATH', '/tmp/oncology_feat_engg.csv')
