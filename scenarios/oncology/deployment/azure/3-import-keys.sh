...
import_key "GenomicsLabFilesystemEncryptionKey" $DATADIR/genomics_lab_key.bin
import_key "PharmaceuticalCompanyFilesystemEncryptionKey" $DATADIR/pharmaceutical_company_key.bin
import_key "ComputationalBiologyLabFilesystemEncryptionKey" $DATADIR/computational_biology_lab_key.bin
import_key "CancerInstituteFilesystemEncryptionKey" $DATADIR/cancer_institute_key.bin
